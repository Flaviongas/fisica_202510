...
Recordemos que la manzana se deja caer desde una altura de 20 m, por lo que $$\vec{r}_0 = 0\hspace{0.3em} \hat{ı}-20\hspace{0.3em} \hat{ȷ} \hspace{0.3em} \left [ m \right ]$$

Entonces la función posición es:
$$
\vec{r} = -4.9 \hspace{0.3em} t^2 \hspace{0.3em} \hat{ȷ} -20\hspace{0.3em} \hat{ȷ} \hspace{0.3em} \left [ m \right ]
$$
